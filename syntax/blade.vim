...
syn keyword bladeTarget cc_binary cc_library cc_plugin cc_test enable_if cc_public_library
syn keyword bladeTarget cc_public_library thrift_library cc_shared_library  cc_benchmark
...
syn keyword bladeArg gen_cpp link_flags implements cflags copt
